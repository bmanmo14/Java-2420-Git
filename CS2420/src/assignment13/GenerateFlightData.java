 ...
 * you are having a hard time generating files. It is not commented so if you want
 * an explanation you can come see me in office hours or send me a message in canvas.</P>
 *
 * <p>My suggestion is to use this file to generate some random data then modify it
...
public class GenerateFlightData {
	...
	private static int edgeCount = 30;
	private static int nodeCount = 10;
	private static String filePath = "testfile2.csv";
